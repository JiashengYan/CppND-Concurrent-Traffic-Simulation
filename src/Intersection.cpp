...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
    ...
    lck.lock();
    std::cout << "Intersection #" << _id << ": Vehicle #" << vehicle->getID() << " is granted entry. wairing for green light" << std::endl;
    lck.unlock();
    ...
    lck.lock();
    std::cout << "TrafficLight #" << _id << ": Vehicle #" << vehicle->getID() << " is granted green light" << std::endl;
    lck.unlock();
}
...
void Intersection::simulate() // using threads + promises/futures + exceptions
{
    ...
    //threads.emplace_back(std::thread(&TrafficLight::cycleThroughPhases,this->_trafficLight));
